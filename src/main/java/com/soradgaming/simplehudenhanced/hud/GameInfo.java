...
public class GameInfo {
    ...
    public String getBiome() {
        ...
        Optional<RegistryKey<Biome>> biome = this.client.world.getRegistryManager().get(Registry.BIOME_KEY).getKey(this.client.world.getBiome(this.player.getBlockPos()));
